...
```js
const Me = {
  name: 'Mohammed Raihan AS',
  located_in: 'Kerala, Indi',
  current_focus: 'MERN Stack Development',
  education: 'Brototype Bootcamp',
  company: 'Everyone is my company now', //jk, no job now
  fields_of_interests: [
...
<img src="https://raw.githubusercontent.com/RaihanAizvan/RaihanAizvan/output/snake.svg" alt="Snake animation" />
